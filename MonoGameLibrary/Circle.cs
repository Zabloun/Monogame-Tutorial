...
public readonly struct Circle : IEquatable<Circle>
{
    ...
    //The x-cord of the centre of this circle
    public readonly int X;

    //The y-cord of the centre of this circle
    public readonly int Y;

    //Length in px from the centre of this circle to the edge
    public readonly int Radius;

    //Get the location of the centre of this circle
    public readonly Point Location => new Point(X, Y);

    //Get a circle with X=0, Y=0, and Radius=0
    ...
    //Gets the y-cord of the highest point on this circle.
    public readonly int Top => Y - Radius;

    //Gets the y-cord of the lowest point on this circle.
    public readonly int Bottom => Y + Radius;

    //Gets the x-cord of the left most point on this circle.
    public readonly int Left => X - Radius;

    //Gets the x-cord of the right most point on this circle.
